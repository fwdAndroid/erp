...
class QuotationConformationScreen extends StatefulWidget {
  const QuotationConformationScreen({super.key});

  @override
  State<QuotationConformationScreen> createState() =>
      _QuotationConformationScreenState();
}

class _QuotationConformationScreenState
    extends State<QuotationConformationScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Center(
            child: Text(
              'You created the quotation successfully',
