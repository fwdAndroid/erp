...
class CustomerConformationScreen extends StatefulWidget {
  const CustomerConformationScreen({super.key});

  @override
  State<CustomerConformationScreen> createState() =>
      _CustomerConformationScreenState();
}

class _CustomerConformationScreenState
    extends State<CustomerConformationScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Center(
            child: Text(
              'You added the customer successfully',
