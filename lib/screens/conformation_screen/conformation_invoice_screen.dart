...
class InvoiceConformationScreen extends StatefulWidget {
  const InvoiceConformationScreen({super.key});

  @override
  State<InvoiceConformationScreen> createState() =>
      _InvoiceConformationScreenState();
}

class _InvoiceConformationScreenState extends State<InvoiceConformationScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Center(
            child: Text(
              'You created the invoice successfully',
